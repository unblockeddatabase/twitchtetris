...
RandomBag.initialList = ["i", "o", "t", "s", "z", "j", "l"];
...
Game.prototype.swap = function() {
    var d, c, b, h = this.controlGroup.getShape(),
...
function sendScoreRequest(c) {
    ...
    b.onreadystatechange = function() {
        if (b.readyState == 4 && b.status == 200) {
            redirCode = b.responseText;
            setTimeout("redirectToScore();", 4000)
        }
    };
    b.open("POST", "/score/reportScore?gthbyu=" + (c * 17), true);
    b.send()
}
